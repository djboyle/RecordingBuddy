...
void Java_com_example_dylbo_RecordingBuddy_ui_LameActivity_initEncoder(JNIEnv *env,
...
void Java_com_example_dylbo_RecordingBuddy_ui_LameActivity_destroyEncoder(
		JNIEnv *env, jobject jobj) {
	int res = lame_close(lame);
	LOGD("Deinit returned: %d", res);
}

void Java_com_example_dylbo_RecordingBuddy_ui_LameActivity_encodeFile(JNIEnv *env,
